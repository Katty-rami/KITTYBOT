...
import Pino from 'pino'
import { OceanJadiBot } from './plugins/jadibot-serbot.js'
...
OceanJadiBot({pathOceanJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
