...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(`${chalk.blue('╭────═[ Katty Bot ]═─────⋆')}
${chalk.blue('│╭───────────────···')}
${chalk.blue('││')}👨‍💻 ${chalk.cyan('%s')} ⏱️ ${chalk.black(chalk.bgBlue('%s'))} 📂 ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.blue('││')}🥷 ${chalk.redBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.blue('││')}💻 ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.blue('│╰────────────────···')}
${chalk.blue('╰───────────═┅═──────────')}`.trim(),
